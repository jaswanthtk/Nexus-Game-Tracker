    ...
    tailwind.config = {
      ...
      theme: {
        extend: {
          ...
          colors: {
            brand: { 400: '#22d3ee', 500: '#06b6d4', 900: '#164e63' },
  ...
  <main class="py-12 flex-grow" id="main" role="main">
    <div class="container-xl space-y-16">
      ...
      <section class="relative overflow-hidden rounded-3xl border border-zinc-800/50 shadow-2xl group" aria-label="Featured Game">
        <div class="absolute inset-0 bg-cover bg-center transition-transform duration-1000 group-hover:scale-105" style="background-image: url('https://placehold.co/1200x500/111/333?text=Daily+Showcase');" id="featured-hero-bg"></div>
      ...
      <section class="bg-zinc-900/40 backdrop-blur border border-zinc-800 rounded-3xl p-8 shadow-xl" aria-label="Profile Details">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6" id="profile-stats">
          ...
          <div class="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 relative overflow-hidden group">
            ...
            <i class="bi bi-clock-history text-[4rem] absolute -bottom-4 -right-4 text-zinc-800/50 group-hover:scale-110 transition-transform"></i>
          </div>
...
ADMIN_SETTINGS = legacy_admin_wrap('System Parameters', '''<form id="settings-form"><div class="mb-4"><label for="settings-sys-name" class="form-label text-light">System Name</label><input type="text" class="form-control bg-dark text-light border-secondary" id="settings-sys-name" value="Nexus"></div><div class="mb-5"><label for="settings-admin-email" class="form-label text-light">Admin Email</label><input type="email" class="form-control bg-dark text-light border-secondary" id="settings-admin-email" value="admin@nexus.local"></div><button type="submit" class="btn btn-primary w-100"><i class="bi bi-save me-2"></i>Save Configuration</button></form><div id="settings-success" class="alert alert-success mt-4 d-none">Configuration saved.</div>''')
