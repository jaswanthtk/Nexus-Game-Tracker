      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-5">
          ...
          <div class="d-flex flex-column gap-3 max-w-sm mx-auto">
            <a href="login.html" class="btn btn-nexus w-100"><i class="bi bi-person-plus-fill me-2"></i>Create Account / Login</a>
            <a href="catalog.html" class="btn btn-outline-amber w-100"><i class="bi bi-box-arrow-in-right me-2"></i>Skip for Now</a>
          </div>
        </div>
      </div>
    </div>
